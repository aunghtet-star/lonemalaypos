         ...
         <div className="flex gap-3">
           ...
           <div className="relative w-full md:w-64">
              ...
              <input
                ...
                className="pl-10 pr-4 py-2 w-full rounded-xl border border-gray-200 bg-white focus:outline-none focus:ring-2 focus:ring-primary/50 text-sm text-gray-800 placeholder-gray-400"
              />
           </div>
         </div>
       </div>
